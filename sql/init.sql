...
CREATE TABLE "public"."avatar" (
    ...
    "created_at" timestamp NOT NULL,
    "updated_at" timestamp NOT NULL,
    CONSTRAINT "avatar_customer_id_fkey" FOREIGN KEY ("customer_id") REFERENCES "public"."profile"("customer_id") ON DELETE CASCADE,
    PRIMARY KEY ("id")
);
...
CREATE TABLE "public"."photo" (
    ...
    "created_at" timestamp NOT NULL,
    "updated_at" timestamp NOT NULL,
    CONSTRAINT "photo_customer_id_fkey" FOREIGN KEY ("customer_id") REFERENCES "public"."profile"("customer_id") ON DELETE CASCADE,
    PRIMARY KEY ("id")
);
